...
namespace AForge.Neuro
{
    ...
    public abstract class Neuron
    {
        ...
        /// 
        protected static Range randRange = new Range(0f, 1f); //( 0.0f, 1.0f );
        ...
        {
            get { return this.inputsCount; } //this
        }
        ...
        {
            // allocate weights
            this.inputsCount = Math.Max( 1, inputs ); // this
            this.weights = new double[this.inputsCount]; //this
        ...
        public virtual void Randomize( )
        {
            ...
            // randomize weights
            for ( int i = 0; i < this.inputsCount; i++ ) //this
                this.weights[i] = (rand.NextDouble( ) * d) + randRange.Min; //this
        }
