...
namespace AForge.Neuro
{
    ...
    public class BipolarSigmoidFunction : IActivationFunction, ICloneable
    {
        ...
        private double alpha; // = 2.0; //deðiþtirdim
        ...
        {
            this.alpha = 2.0; //burasý yoktu
            this.alpha = alpha; //this ekledim
        }
        ...
        {
            double y = this.Function( x ); //this yazdým

            return ( this.alpha * (( 1.0 - (y * y ))) / 2.0 ); //this yazdým
        }
        ...
        public object Clone( )
        {
            return new BipolarSigmoidFunction( this.alpha ); //this yazdým
        }
    }
}
