...
{
    public partial class PivotPage5 : PhoneApplicationPage
    {
        public PivotPage5()
        {
            InitializeComponent();
            ...
            listPicker.ItemsSource = new List<string>() { "Doğum Günü", "Yıl Dönümü", "Yılbaşı" };
        }

        private void Button_Click(object sender, RoutedEventArgs e)
        {
            int kutlama = listPicker.SelectedIndex + 1;
            PhoneApplicationService.Current.State["kutlama"] = kutlama;
