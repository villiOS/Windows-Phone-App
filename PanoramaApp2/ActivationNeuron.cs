...
namespace AForge.Neuro
{
    ...
    public class ActivationNeuron : Neuron
    {
        ...
        public override void Randomize( )
        {
            ...
            this.threshold = (Neuron.rand.NextDouble() * Neuron.randRange.Length) + Neuron.randRange.Min;
        }
        ...
        public override double Compute( double[] input )
        {
            ...
            //return output;
            if (input.Length != base.inputsCount)
            {
                throw new ArgumentException("Wrong length of the input vector.");
            }
            double sum = 0.0;
            ...
            {
                sum += base.weights[i] * input[i];
            }
            sum += this.threshold;
            double output = this.function.Function(sum);
            base.output = output;
            return output;
