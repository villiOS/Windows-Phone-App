...
namespace AForge.Neuro
{
    ...
    public class ActivationLayer : Layer
    {
        ...
        {
            // create each neuron
            for (int i = 0; i < base.neurons.Length; i++)
            {
                base.neurons[i] = new ActivationNeuron(inputsCount, function); //base
            }
        }
        ...
        public void SetActivationFunction( IActivationFunction function )
        {
            ...
            {
                ( (ActivationNeuron) base.neurons[i] ).ActivationFunction = function;
            }
        }
    }
}
